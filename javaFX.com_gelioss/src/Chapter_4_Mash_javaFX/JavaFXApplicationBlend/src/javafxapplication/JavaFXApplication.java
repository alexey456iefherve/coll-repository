 ...
 * the editor.
 */
package Chapter_4_Mash_javaFX.JavaFXApplicationBlend.src.javafxapplication;
...
public class JavaFXApplication extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        btn.setStyle("-fx-font:italic bold 18pt Georgia; -fx-text-fill: white;-fx-background-color:black;");
        
        Stop[] stops = new Stop[] {new Stop(0, Color.BROWN), new Stop(1, Color.YELLOW)};
