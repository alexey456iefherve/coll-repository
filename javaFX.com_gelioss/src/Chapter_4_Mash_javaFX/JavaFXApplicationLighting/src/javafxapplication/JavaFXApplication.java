 ...
 * the editor.
 */
package Chapter_4_Mash_javaFX.JavaFXApplicationLighting.src.javafxapplication;
...
public class JavaFXApplication extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        btn.setStyle("-fx-font: bold italic 14pt Georgia;-fx-text-fill: white;-fx-background-color: #a0522d;" );       
