package chapter8_javaFX_8.ChartApp11.src;
...
public class ChartApp11 extends Application {
    ...
    private ObservableList<Series<Integer, Double>> getChartData() {
        double javaValue = 17.56;
        double cValue = 17.06;
        double cppValue = 8.25;
        ObservableList<Series<Integer, Double>> answer = FXCollections.observableArrayList();
