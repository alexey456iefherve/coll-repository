 ...
 * the editor.
 */
package Chapter_9_Mash_javaFX.JavaApplicationSwingApplet.src.main;
...
private void initFX(javafx.embed.swing.JFXPanel fxPanel) {
    ...
    @Override public void handle(ActionEvent e) {
        ...
        Image imPause=new Image(this.getClass().getResource("player_pause.png").toString());
    ...
    @Override public void handle(ActionEvent e) {
        ...
        playerVideo.currentTimeProperty().addListener(new ChangeListener<Duration>(){
            @Override
    public void changed(ObservableValue<? extends Duration> ov,Duration old_value, Duration new_value) {
...
public void changed(ObservableValue<? extends Number> ov,Number old_val, Number new_val) {
        ...
        HBox hbox=new HBox();
        hbox.setSpacing(5);
        hbox.setAlignment(Pos.CENTER);        hbox.getChildren().addAll(btnPlay,btnPause,btnStop,sliderV,volume);
        VBox vbox=new VBox();        
        vbox.setSpacing(20);
    ...
    public void init() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JAppletWithJavaFX.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
