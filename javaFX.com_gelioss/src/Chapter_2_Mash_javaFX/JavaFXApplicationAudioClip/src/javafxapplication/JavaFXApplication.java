 ...
 * the editor.
 */
package Chapter_2_Mash_javaFX.JavaFXApplicationAudioClip.src.javafxapplication;
...
public class JavaFXApplication extends Application {   
    ...
    public void start(Stage primaryStage) {
        ...
        final AudioClip player=new AudioClip(this.getClass().getResource("audio.mp3").toString());
